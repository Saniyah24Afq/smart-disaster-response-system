...
function ResponseTeamDashboard() {
  ...
  const activeAssignments = assignments.filter(
    (item) => item.assignment_status !== "RESOLVED"
  );
  ...
  const criticalAssignments = assignments.filter(
    (item) =>
      ...
      item.assignment_status !== "RESOLVED"
  );
  ...
  if (loading) {
    return (
      <div className="response-loading">
        ...
        <h2>Loading response center...</h2>
        <p>Connecting to RESQ emergency network</p>
      </div>
    );
  }
    ...
    <div className="response-dashboard">
      ...
      <header className="response-header">
        <div className="brand-area">
          ...
          <div>
            <h1>RESQ Response Center</h1>
            <p>Emergency Response Operations</p>
          </div>
        </div>
        ...
        <div className="header-actions">
          ...
          <div className="team-user">
            ...
            <div>
              <strong>{user.name || "Response Team"}</strong>
              <small>Response Officer</small>
            </div>
          </div>
        </div>
      </header>
      ...
      <section className="response-hero">
        <div className="hero-content">
          ...
          <p>
            Monitor assigned emergencies, coordinate field operations,
      ...
      <section className="response-stats">
        ...
        <div className="response-stat">
          ...
          <div>
            ...
            <strong>{criticalAssignments.length}</strong>
          </div>
        </div>
        ...
        <div className="response-stat">
          ...
          <div>
            ...
            <strong>
              {
                assignments.filter(
                  (item) => item.assignment_status === "IN_PROGRESS"
                ).length
              }
            </strong>
          </div>
        ...
        <div className="response-stat">
          ...
          <div>
            <span>Resolved</span>
            <strong>{resolvedAssignments.length}</strong>
          </div>
        </div>
      </section>
      ...
      <main className="response-main">
        <div className="section-heading">
          <div>
            ...
            <h2>My Assigned Emergencies</h2>
          </div>

          <span className="mission-count">
            {assignments.length} {assignments.length === 1 ? "Mission" : "Missions"}
          </span>
        </div>
        ...
        {assignments.length === 0 ? (
          <div className="empty-missions">
            ...
            <p>
              You're currently available. New emergency assignments will
              appear here.
            </p>
          </div>
        ) : (
          <div className="mission-grid">
            {assignments.map((assignment) => (
              <article className="mission-card" key={assignment.id}>
                {/* CARD TOP */}
                <div className="mission-top">
                  <div className="mission-type">
                    ...
                    <div>
                      <span>INCIDENT #{assignment.disaster_id}</span>
                      <h3>{assignment.disaster_type}</h3>
                    </div>
                  </div>
                ...
                <div className="mission-details">
                  ...
                  <div className="detail-item">
                    ...
                    <div>
                      <span>Team</span>
                      <strong>{assignment.team_name}</strong>
                    </div>
                  </div>
                  ...
                  <div className="detail-item">
                    ...
                    <div>
                      ...
                      <strong>{assignment.team_phone || "N/A"}</strong>
                    </div>
                  </div>
                </div>
                ...
                <div className="mission-actions">
                  ...
                  {assignment.assignment_status === "IN_PROGRESS" && (
                    <button
                      ...
                      disabled={actionLoading === assignment.id}
                      onClick={() =>
                        updateStatus(assignment.id, "RESOLVED")
                      }
                    >
                      <Check size={18} />
                      {actionLoading === assignment.id
      ...
      <footer className="response-footer">
        <div>
          <ShieldCheck size={18} />
          <span>RESQ Emergency Network</span>
        </div>
